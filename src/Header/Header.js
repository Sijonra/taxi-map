            ...
            <header className="section-header">
                <nav className="header-nav">
                    ...
                    <ul className="header-nav-list">
                        <li onClick={ () => this.props.setPage('login') } className="nav-list__item">Login</li>
                        <li onClick={ () => this.props.setPage('register') } className="nav-list__item">Register</li>
                        <li onClick={ () => this.props.setPage('map') } className="nav-list__item">Map</li>
                        <li onClick={ () => this.props.setPage('profile') } className="nav-list__item">Profile</li>
                    </ul>
                </nav>
            </header>
        )
